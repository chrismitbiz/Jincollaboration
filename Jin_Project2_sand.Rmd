...
<br/>
```{r boxplotsILRVERT, eval=TRUE, echo=FALSE, fig.width=7,  fig.asp = 1.5,message=FALSE, warning=FALSE, cache=FALSE, fig.cap= "Isometric Log Ratios (ILR) of taxa groups with abundances that significantly changed over time and under elevated CO2 of taxa bins identifed with phylofactor (model days*CO2, n = 24)."}
require(phylofactor)
PF.mult <- readRDS('~/Documents/Study/LaTrobe/Research/phD/Jin_Project2_Sand/phylofactor/PF.mult_VERTISOLdays+CO2')
...
pdf(NULL)
boxplots <- ggarrange(p00.3, p0.3, p12.3, p1.3, p1.4, p2.3, p3.3, nrow = 7) 
x = dev.off()
boxplots
```
...
bin <- rbind(bin6, bin7, bin8,bin10, bin11,bin16, bin17, bin23, bin24, bin25, bin26)
