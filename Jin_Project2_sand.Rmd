...
```{r, heatmapch_bac_plot, fig.height=9, fig.width=11, message= FALSE, warning=FALSE, echo= FALSE, cache = FALSE}
...
```{r, heatmapch_bacvert_plot, fig.height=9, fig.width=11, message= FALSE, warning=FALSE, echo= FALSE, cache = FALSE}
p + ggtitle( "Correlations of clr transformed abundances on genus level")
```
