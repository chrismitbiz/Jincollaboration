...
## Phylofactor
```{r, phylfactor2, eval=TRUE, echo=FALSE, message=FALSE, warning=FALSE, cache=FALSE, fig.cap= "Change of relative abundances which significantly changed over time and under elevated CO2 of taxa bins identifed with phylofactor (model days+CO2, n = 24)."}
require(phylofactor)
